...
--*/
{
    ...
    pnpPowerCallbacks.EvtDevicePrepareHardware = USBEEDriverEvtDevicePrepareHardware;
    ...
    if (NT_SUCCESS(status)) {
        ...
        if (NT_SUCCESS(status)) {
            ...
            //
            status = USBEEDriverQueueInitialize(device);
        }
    }
...
NTSTATUS
USBEEDriverEvtDevicePrepareHardware(
